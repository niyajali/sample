...
import search.generated.resources.Res
import search.generated.resources.feature_search_clear_recent_searches_content_desc
import search.generated.resources.feature_search_clear_search_text_content_desc
import search.generated.resources.feature_search_interests
import search.generated.resources.feature_search_not_ready
import search.generated.resources.feature_search_recent_searches
import search.generated.resources.feature_search_result_not_found
import search.generated.resources.feature_search_title
import search.generated.resources.feature_search_to_browse_topics
import search.generated.resources.feature_search_topics
import search.generated.resources.feature_search_try_another_search
import search.generated.resources.feature_search_updates
import ui.generated.resources.Res.string
                    ...
                    Text(
                        text = buildAnnotatedString {
                            withStyle(style = SpanStyle(fontWeight = FontWeight.Bold)) {
                                append(stringResource(Res.string.feature_search_topics))
                            }
                        },
            ...
            if (newsResources.isNotEmpty()) {
                item(
                    ...
                    Text(
                        text = buildAnnotatedString {
                            withStyle(style = SpanStyle(fontWeight = FontWeight.Bold)) {
                                append(stringResource(Res.string.feature_search_updates))
                            }
                        },
                        modifier = Modifier.padding(horizontal = 16.dp, vertical = 8.dp),
                    )
    ...
    Column {
        Row(
            ...
            Text(
                text = buildAnnotatedString {
                    withStyle(style = SpanStyle(fontWeight = FontWeight.Bold)) {
                        append(stringResource(Res.string.feature_search_recent_searches))
                    }
                },
                modifier = Modifier.padding(horizontal = 16.dp, vertical = 8.dp),
            )
                ...
                IconButton(
                    ...
                    Icon(
                        ...
                        contentDescription = stringResource(
                            Res.string.feature_search_clear_recent_searches_content_desc,
                        ),
    ...
    TextField(
        ...
        leadingIcon = {
            Icon(
                ...
                contentDescription = stringResource(
                    Res.string.feature_search_title,
                ),
                tint = MaterialTheme.colorScheme.onSurface,
            )
        },
            ...
            if (searchQuery.isNotEmpty()) {
                IconButton(
                    ...
                    Icon(
                        imageVector = NiaIcons.Close,
                        contentDescription = stringResource(
                            Res.string.feature_search_clear_search_text_content_desc,
                        ),
                        tint = MaterialTheme.colorScheme.onSurface,
                    )
                }
