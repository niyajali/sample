...
import com.google.samples.apps.nowinandroid.core.data.util.runBlockingExt
...
class TestNiaNetworkDataSource : NiaNetworkDataSource {
    ...
    private val allTopics: List<NetworkTopic> = runBlockingExt { source.getTopics() }

    private val allNewsResources: List<NetworkNewsResource> =
        runBlockingExt { source.getNewsResources() }
