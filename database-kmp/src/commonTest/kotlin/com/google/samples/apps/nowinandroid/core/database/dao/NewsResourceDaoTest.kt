...
import com.google.samples.apps.nowinandroid.core.database.databaseTest
...
internal class NewsResourceDaoTest {

    private lateinit var newsResourceDao: NewsResourceDao
    private lateinit var topicDao: TopicDao

    @BeforeTest
    fun setup() = databaseTest {
        newsResourceDao = NewsResourceDaoImpl(it, Dispatchers.Unconfined)
        topicDao = TopicDaoImpl(it, Dispatchers.Unconfined)
    }
